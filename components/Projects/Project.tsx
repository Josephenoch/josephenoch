...
const Project:FC<Props> = ({project}) => {
  ...
  return (
    <div title={project.description} className="hover:scale-105 transition-all duration-200 ease-linear cursor-pointer lg:ml-10 w-3/4 lg:w-80 mt-10 h-fit flex flex-col space-y-2">
        ...
        <div className="w-full h-64 border-[0.5px] rounded-lg border-white/20">
            ...
            <div className="h-1/2 p-6 space-y-2 border-t-[0.5px] rounded-b-lg border-white/20 bg-primary-light">
                ...
                <div className="space-x-3">
                    ...
                    {project.github &&<a href={project.github} target="_blank" rel="noreferrer" className="bg-[#1C2B3A]/60  text-lg rounded-xl hover:bg-[#1C2B3A]/80 active:bg-[#1C2B3A] hover:scale-[1.02] active:scale-90 transition-all duration-100 ease-linear"><i className="fab fa-github"></i></a>}
                </div>
            </div>
        </div>
    </div>
