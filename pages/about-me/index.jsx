  ...
  return (
    <>
      <LeftComponent pageTitle="personal-info"/>
        ...
        <section className="hidden lg:block w-[41.4%] h-full border-l-2 border-lines">
          <aside className="lg:h-full h-fit border-r-2 border-t-2 border-lines mt-8 py-5 px-7  lg:overflow-y-auto scrollbar-y text-secondary text-sm">
            <CodeShowCaseSection/>
          </aside>
        </section>
    </>
