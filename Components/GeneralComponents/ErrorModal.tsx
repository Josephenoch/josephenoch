        ...
        <div className="absolute translate-x-1/2 translate-y-1/2 right-1/2 p-4 w-full max-w-md h-full md:h-auto">
            <div className="relative bg-primary-light ring-2 ring-secondary rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-6 text-center">
                    ...
                    <button onClick={close} data-modal-toggle="popup-modal" type="button" className="text-accent-pink  hover:scale-105 active:scale-90 transition-all duration-150 ease-linear focus:outline-none border-2 border-accent-pink focus:ring-accent-pink/30 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                        Dismiss
                    </button>
